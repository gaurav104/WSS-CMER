from graphs.models.res_unet import *
import numpy as np
...
class ResUnetAgent(BaseAgent):
    ...
    def __init__(self, config):
        ...
        self.model = ResUNet(self.in_ch, self.num_cls, self.config.attention)
        ...
        self.best_loss = 1e4 # a very high value
    ...
    def save_checkpoint(self, filename='checkpoint.pth.tar', is_best=0):
        ...
        state = {
            ...
            'best_loss_value': self.best_loss,
    ...
    def load_checkpoint(self, filename):
        ...
        try:
            ...
            self.best_loss = checkpoint['best_loss_value']
    ...
    def train(self):
        ...
        for epoch in range(self.current_epoch, self.config.max_epoch):
            ...
            valid_ce, valid_dice  = self.validate()
            # self.scheduler.step(valid_loss)

            is_best = valid_ce + valid_dice < self.best_loss

            if(is_best):
                self.best_loss = valid_ce + valid_dice 
